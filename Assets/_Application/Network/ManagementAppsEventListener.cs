...
//-----------------------------------------------------------------------------------------------------------------------------------
public class ManagementAppsEventListener : MonoBehaviour
{
	//-------------------------------------------------------------------------------------------------------------------------------
	// -
	//-------------------------------------------------------------------------------------------------------------------------------
	public static ManagementAppsEventListener	This	= (null);
...
//				app.Confirm.ON( Func.Script( (TEXT.__를_구매했습니다_구매하신_항목은_장바구니에서_사용하실_수_있습니다), app.Language.Get(appsitem.Name()) ) );
	...
	void onFailed( AppsParameter col )
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		Debug.Log("(Failed : "+col.Get("text")+") => "+col.www.url);
	...
	void onUpdateEnd( AppsParameter col )
	{
		...
		if( (col.www)==(null) )
		{
			Apps.Update( Apps.LoadUpdateTime() );
		}
		else
		{
			//-----------------------------------------------------------------------------------------------------------------------
	...
	void onItemState( AppsParameter col )
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		if( ( AppsFunc.IsEditor() && (col.www)!=(null) && (data.Log) ) || Func.IsPlayer() )
		{
...
//		Debug.LogWarning( col.GetEcho() );
	...
	public static void Indigator()
	{
		...
		if( (This)!=(null) )
		{
			CApp.This.ViewIndigator.ON( This.transform );
		}
