...
//		if( (data)==(null) ) return;	//(NULL)값을 허용함
	...
	void funcDestroy( object wParam=(null), object lParam=(null) )
	{
		...
		ManagementHash.DepartmentDestroy( wParam as string );
	...
	void funcProductDispose( object wParam=(null), object lParam=(null) )
	{
		...
		ManagementHash.ProductDispose( wParam as string );
...
//		if( (focus)==(null) ) return false;		//(NULL)값을 허용함
	...
	public float Fold()
	{
		...
		if( IsFold() )
		{
			...
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			float scroll = ( (Transform().sizeDelta.y) - (Data().foldHeight) ) / (2);
		...
		else
		{
			...
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			float scroll = ( (Transform().sizeDelta.y) - (120) ) / (2);
