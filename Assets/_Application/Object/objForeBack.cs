...
//		(data.image.rectTransform.sizeDelta)	= new Vector2( tagSystem.GetScreenWidth(), tagSystem.GetScreenHeight() );
		...
		if( (viewPanel)!=(null) )
		{
			_Transform().SetSiblingIndex( viewPanel._Transform().GetSiblingIndex()-(1) );
		}
		else
		{
...
//		bool isContains = data.Instances.Contains(instance);
	...
	public bool Is()
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		if( (data.panel)!=(null) && data.panel.Is() )
		{
			return true;
		}
	...
	public float GetDepth()
	{
		...
		{
			return (data.canvas.Camera().depth);
		}
