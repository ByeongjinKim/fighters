...
public class CPlay : MonoBehaviour
{
	...
	// -
	//-------------------------------------------------------------------------------------------------------------------------------
	public tagFocus				Push				= new tagFocus();
	public tagFocus				Context				= new tagFocus();
	public tagFocus				Wheel				= new tagFocus();
	public tagFocus				Focus				= new tagFocus();
	public tagFocus				Rollover			= new tagFocus();
	public tagFocus[]			Touch				= (null);
...
//	public int					preDayUpdate		= (Func.Now().Day);
	...
	// -
	//-------------------------------------------------------------------------------------------------------------------------------
	public objCamera			mainCamera			= (null);

	//-------------------------------------------------------------------------------------------------------------------------------
	// -
	//-------------------------------------------------------------------------------------------------------------------------------
	public objCanvas			foreCanvas			= (null);
	public objCanvas			forwardCanvas		= (null);
	public objCanvas			uiCanvas			= (null);
	public objCanvas			sceneCanvas			= (null);
