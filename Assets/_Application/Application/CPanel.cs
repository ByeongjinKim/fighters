...
public class CPanel : MonoBehaviour
{
	...
	public void _Action()
	{
		...
		for( int i=0; i<(GetList().Count); i++ )
		{
			...
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			if( panel.Is() && panel.ReciveComponent()!=(null) )
			{
		...
		if( _panel.Is() )
		{
			...
			else
			{
				...
				for( int i=0; i<(End); i++ )
				{
					...
					// -
					//---------------------------------------------------------------------------------------------------------------
					if( (panel)!=(null) && panel.Is() )
					{
						//-----------------------------------------------------------------------------------------------------------
						// -
						//-----------------------------------------------------------------------------------------------------------
						(panel.Transform().localPosition)	= new Vector3( (panel.Transform().localPosition.x), (panel.Transform().localPosition.y), (n*-50) );
						(n)		+= (1);
...
//		if( (focus)==(null) ) return false;		//(NULL)값을 허용함
		...
		for( int i=(End-1); i>=(0); i-- )
		{
			...
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			if( (panel)!=(null) && panel.Is() && panel.ReciveComponent()!=(null) )
			{
				//-------------------------------------------------------------------------------------------------------------------
				// -
				//-------------------------------------------------------------------------------------------------------------------
