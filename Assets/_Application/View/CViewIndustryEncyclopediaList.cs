...
//				if( (listInterface)!=(null) && !listInterface.IList_AllowList(productstatic) ) continue;
			if( (_productstatic)!=(null) && ( !Func.Is(productstatic.resource) || ( (productstatic.resource)!=(_productstatic.id) && productstatic.resource.IndexOf("/"+(_productstatic.id)+"/")<(0) ) ) ) continue;
