...
//			app.ViewStorage.funcOnAndDownload();
	...
	public override void Loader()
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		base.Loader( (sample), app.Engine.GetGlobalUICanvas() );
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		(data.item)				= (Func.Get( _Transform(), "Bottom/Item" ).GetComponent(typeof(objControl)) as objControl);
		(data.service)			= (Func.Get( _Transform(), "Bottom/Service" ).GetComponent(typeof(objControl)) as objControl);
		(data.coin)				= (Func.Get( _Transform(), "Bottom/Coin" ).GetComponent(typeof(objControl)) as objControl);
		(data.pet)				= (Func.Get( _Transform(), "Bottom/Pet" ).GetComponent(typeof(objControl)) as objControl);
		(data.character_card)	= (Func.Get( _Transform(), "Bottom/CharacterCard" ).GetComponent(typeof(objControl)) as objControl);
		(data.storage)			= (Func.Get( _Transform(), "Bottom/Storage" ).GetComponent(typeof(objControl)) as objControl);
