...
//			app.ViewItemThumbnail.OFF();
	...
	public override void Loader()
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		(data.text)		= (Func.Get( _Transform(), "Text" ).GetComponent(typeof(Text)) as Text);
		(data.buy)		= (Func.Get( _Transform(), "Buttons/Buy" ).GetComponent(typeof(objControl)) as objControl);
		(data.browse)	= (Func.Get( _Transform(), "Buttons/Browse" ).GetComponent(typeof(objControl)) as objControl);
