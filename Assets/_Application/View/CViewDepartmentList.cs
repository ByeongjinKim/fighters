...
public class CViewDepartmentList : ViewPanel
{
	...
	public override bool ONCONTROL( objControl control, CONTROL_ACTION Action, tagFocus focus )
	{
		...
		foreach( uiIcon icon in GetList() )
		{
			...
			{
				app.Confirm.ON( Func.Script( app.Language.Get(TEXT.__부를_개설하시겠습니까), app.Language.Get(app.DepartmentStatic._GetName(icon.Get())) ), (CONFIRM.YESNO), (funcBuild), icon.Get() );
				return true;
			}
		}
