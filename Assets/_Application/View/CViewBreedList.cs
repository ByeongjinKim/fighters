...
public class CViewBreedList : ViewPanel
{
	...
	void funcBreed( object wParam=(null), object lParam=(null) )
	{
		...
		ManagementHash.Breed( app.Business.Get(), (wParam as string), (lParam as tagProductStatic) );
	...
	public override bool ONCONTROL( objControl control, CONTROL_ACTION Action, tagFocus focus )
	{
		...
		foreach( uiIcon icon in GetList() )
		{
			...
			{
				app.Confirm.ON( Func.Script( app.Language.Get(TEXT.__를_사육하시겠습니까), app.Language.Get(app.ProductStatic._GetName(icon.Get())) ), (CONFIRM.YESNO), (funcBreed), app.Department.GetID(), icon.Get() );
				return true;
			}
