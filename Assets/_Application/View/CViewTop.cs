...
public class CViewTop : ViewPanel
{
	...
	public override void Loader()
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		(data.identity)		= (Func.Get( _Transform(), "Identity" ).GetComponent(typeof(uiIdentity)) as uiIdentity);
		(data.transfer)		= (Func.Get( _Transform(), "Transfer" ).GetComponent(typeof(uiCity)) as uiCity);
		(data.notify)		= (Func.Get( _Transform(), "Notify" ).GetComponent(typeof(objControl)) as objControl);
		(data.foundation)	= (Func.Get( _Transform(), "Foundation" ).GetComponent(typeof(objControl)) as objControl);
		(data.build)		= (Func.Get( _Transform(), "Build" ).GetComponent(typeof(objControl)) as objControl);
		(data.cash)			= (Func.Get( _Transform(), "Cash" ).GetComponent(typeof(objControl)) as objControl);
		(data.business)		= (Func.Get( _Transform(), "Tabs/Business" ).GetComponent(typeof(objControl)) as objControl);
		(data.world)		= (Func.Get( _Transform(), "Tabs/World" ).GetComponent(typeof(objControl)) as objControl);
		(data.stock)		= (Func.Get( _Transform(), "Tabs/Stock" ).GetComponent(typeof(objControl)) as objControl);
