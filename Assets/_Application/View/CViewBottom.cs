...
public class CViewBottom : ViewPanel
{
	...
	public void Forward()
	{
		...
		if( Is() )
		{
			...
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			_Transform().SetParent( play.forwardCanvas._RectTransform() );
	...
	public void Restore()
	{
		...
		if( Is() )
		{
			...
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			_Transform().SetParent( Canvas()._RectTransform() );

			//-----------------------------------------------------------------------------------------------------------------------
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			_Transform().SetSiblingIndex( Canvas().ForeBack()._Transform().GetSiblingIndex() );
...
//		if( app.ViewConverse.Is() ) return false;
	...
	public override void Loader()
	{
		...
		// -
		//---------------------------------------------------------------------------------------------------------------------------
		(data.business)	= (Func.Get( _Transform(), "Business" ).GetComponentInChildren(typeof(objControl)) as objControl);
		(data.product)	= (Func.Get( _Transform(), "Product" ).GetComponentInChildren(typeof(objControl)) as objControl);
		(data.home)		= (Func.Get( _Transform(), "Home" ).GetComponentInChildren(typeof(objControl)) as objControl);
		(data.company)	= (Func.Get( _Transform(), "Company" ).GetComponentInChildren(typeof(objControl)) as objControl);
		(data.stock)	= (Func.Get( _Transform(), "Stock" ).GetComponentInChildren(typeof(objControl)) as objControl);
