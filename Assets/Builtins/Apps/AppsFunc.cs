...
//			(GameObject.FindObjectOfType(typeof(CConfirm)) as CConfirm).ON( text );
	...
	// 텍스쳐 정보를 불러오기 위한 함수
	//-------------------------------------------------------------------------------------------------------------------------------
	public static void Parse( tagTexture texture, string json )
	{
	    //---------------------------------------------------------------------------------------------------------------------------
	    // -
	    //---------------------------------------------------------------------------------------------------------------------------
		...
		if( texture.Update )
		{
			...
			{
				if( Func.Is(texture.oldUrl) && File.Exists(CEngine.GetStreamingPath(texture.oldUrl)) )
				{
					Debug.Log( "(StreamingAsset-Delete) => "+CEngine.GetStreamingPath(texture.oldUrl) );
					Func.Delete( CEngine.GetStreamingPath(texture.oldUrl) );
				}
			}
			else
			{
				if( Func.Is(texture.oldUrl) && File.Exists(CEngine.GetCachePath(texture.oldUrl)) )
				{
					Debug.Log( "(Cache-Delete) => "+CEngine.GetCachePath(texture.oldUrl) );
					Func.Delete( CEngine.GetCachePath(texture.oldUrl) );
				}
			}
	...
	// 애셋번들 정보를 얻기 위한 함수
	//-------------------------------------------------------------------------------------------------------------------------------
    public static void Parse( tagAssetBundle assetBundle, string json )
    {
	    //---------------------------------------------------------------------------------------------------------------------------
	    // -
	    //---------------------------------------------------------------------------------------------------------------------------
	...
	// 애셋번들 정보를 얻기 위한 함수
	//-------------------------------------------------------------------------------------------------------------------------------
    public static void Parse( tagAssetBundle assetBundle, AppsParameter col )
    {
	    //---------------------------------------------------------------------------------------------------------------------------
	    // -
	    //---------------------------------------------------------------------------------------------------------------------------
		...
		if( assetBundle.Update )
		{
			...
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			if( (Application.isEditor) && Func.Is(assetBundle.oldUrl) )
			{
				Debug.Log( "(StreamingAsset-Delete) => "+CEngine.GetStreamingPath((assetBundle.oldUrl), (false)) );
				Func.Delete( CEngine.GetStreamingPath((assetBundle.oldUrl), (false)) );
			}

			//-----------------------------------------------------------------------------------------------------------------------
			// -
			//-----------------------------------------------------------------------------------------------------------------------
			if( Platform.IsRuntime() && Func.Is(assetBundle.oldUrl) )
			{
				Debug.Log( "(Cache-Delete) "+CEngine.GetCachePath(assetBundle.oldUrl) );
				Func.Delete( CEngine.GetCachePath(assetBundle.oldUrl) );
			}
